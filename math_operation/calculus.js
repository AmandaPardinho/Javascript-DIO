...
2 - gasto de combustível do carro por quilômetro;\n\
3 - distância percorrida, em quilômetros, na viagem.")
...
let valorViagem = ((distanciaViagem * precoCombustivel) / 15);

console.log("O valor total gasto na viagem será de R$ " + valorMedio.toFixed(2) + ".");
